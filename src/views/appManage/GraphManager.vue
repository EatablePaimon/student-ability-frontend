                ...
                <template #default="scope">
                    <div class="button-group">
                        <div class="button-row ">
                            ...
                            <el-button v-if='authStore.isAdmin' type="primary" @click="goToPermission(scope.row.ID)">权限</el-button>
                        </div>
                        <div class="button-row">
                            <el-button v-if='authStore.isAdmin' type="primary" @click="goToEdit(scope.row.ID)">编辑</el-button>
                            <el-button v-if='authStore.isAdmin' type="danger" @click="remove(scope.row.ID)">删除</el-button>
                        </div>
                    </div>
                </template>
            </el-table-column>
